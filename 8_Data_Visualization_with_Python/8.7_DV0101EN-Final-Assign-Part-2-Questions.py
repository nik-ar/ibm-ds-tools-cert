...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        average_sales = recession_data.groupby('Vehicle_Type', as_index=False).agg({'Automobile_Sales': 'mean'})                 
        R_chart2  = dcc.Graph(
            figure=px.bar(
                average_sales,
                x='Vehicle_Type',
...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
        ...
        exp_rec= recession_data.groupby('Vehicle_Type', as_index=False).agg({'Advertising_Expenditure': 'sum'})
        R_chart3 = dcc.Graph(
            figure=px.pie(
                exp_rec,
                values='Advertising_Expenditure',
                names='Vehicle_Type',
                title="Proportion between advertising expenditures by vehicle types"
            )
        )
